...
class GPT2Wrapper(ModelWrapper):
    ...
    def __init__(self, model_name: str = "gpt2-xl", use_cuda: bool = True):
        ...
        if model_name.find('gpt') != -1:
            ...
            # cache_dir = "/Projects/GPS-main/pretrained_model"
            # self._tokenizer = AutoTokenizer.from_pretrained("google/t5-xxl-lm-adapt", cache_dir=cache_dir)
            # self._model = AutoModelForSeq2SeqLM.from_pretrained("google/t5-xxl-lm-adapt", cache_dir=cache_dir)
            # self.model_name = 't5'
